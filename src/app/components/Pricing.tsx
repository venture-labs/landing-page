...
function PricingCard({
  ...
  return (
    <motion.div
      ...
      className="flex flex-col flex-1 min-w-[280px] bg-[#1c1a27] overflow-hidden border border-white/8"
    >
      <div className="p-10 flex flex-col gap-8">
        <div className="flex items-center justify-between">
          <div className="w-10 h-10 flex items-center justify-center" style={{ backgroundColor: plan.badgeColor + "20" }}>
